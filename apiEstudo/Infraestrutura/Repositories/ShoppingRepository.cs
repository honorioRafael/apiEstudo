...
{
    public class ShoppingRepository : BaseRepository<Shopping, InputCreateShopping, InputUpdateShopping, InputCreateShoppingComplete, InputInternalCreateShopping>, IShoppingRepository
    {
