...
{
    public class ShoppingService : BaseService<IShoppingRepository, InputCreateShopping, InputUpdateShopping, InputIdentityUpdateShopping, InputIdentityDeleteShopping, OutputShopping, ShoppingDTO, ShoppingExternalPropertiesDTO, ShoppingInternalPropertiesDTO, ShoppingAuxiliaryPropertiesDTO>, IShoppingService
    {
        ...
        public override List<long> CreateMultiple(List<InputCreateShopping> listInputCreateShopping)
        {
            ...
            var idRange = _idControlRepository.GetRangeId(TableName.GetNameId("Shopping"), listInputCreateShopping.Count);
        ...
        private void CreateMultipleShoppingItens(long shopId, List<InputCreateShoppingItem> listInputCreateShoppingItem)
        {
            ...
            var idRange = _idControlRepository.GetRangeId(TableName.GetNameId("ShoppingItem"), listInputCreateShoppingItem.Count);
            var id = idRange.FirstId;
